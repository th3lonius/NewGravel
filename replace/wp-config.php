...
define('DB_NAME', 'th3loniu_wpcochran');

/** MySQL database username */
define('DB_USER', 'th3loniu_wpadmin');

/** MySQL database password */
define('DB_PASSWORD', 'cogburn1');
...
define('WP_HOME', 'http://matthewmesaros.com/cochran');
define('WP_SITEURL', 'http://matthewmesaros.com/cochran');
